...
const service = {
  ...
  methods: {
    async authorize (ctx, route, req) {
      ...
      if (!bearerToken || !bearerToken.startsWith('Bearer')) throw unauthorized('Access Token is required')
      ...
      if (!this.validateScopes(auth, tokenData)) {
        if (!Array.isArray(auth.self) || !tokenData.sub) throw unauthorized('Invalid Scopes')
